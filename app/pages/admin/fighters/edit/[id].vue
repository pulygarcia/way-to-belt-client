<script setup lang="ts">
    ...
    await useAsyncData('fetchFighter', async () => {
        await fightersStore.fetchFighterById(Number(fighterId));
        return true
    });
    ...
    const [zodPlugin, submitHandler] = createZodPlugin(
        fighterSchema,
        async (formData) => {
            await fightersStore.updateFighter(Number(fighterId), formData);
            toast.success('Peleador actualizado con éxito');
            reset('formRef');
        }
    )
</script>
